...
- communication between container and service
  - cluster label must match with service name
  ...
  ```
- if there is no container then the communication between service and host runner will be through out port
communication between service container and host runner
